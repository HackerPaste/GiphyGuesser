...
module.exports = (props) => (
  <div>
    <div className="screenWrap">
      ...
      <div>
        <div className="winningText">{props.gameOverFlag}The Winner is: {props.gameOver.winner}!!!</div>
        <div className="winningText">{props.gameOverFlag}The winning phrase was {props.gameOver.winningPhrase}</div>
